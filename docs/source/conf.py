...
# -*- coding: utf-8 -*-
#
# tbkit documentation build configuration file, created by
...
# gallery of executed, thumbnailed pages under docs/api/gallery/, so the
# rendered docs and the runnable scripts in examples/ never drift apart --
# the script is the single source of truth for both.
sphinx_gallery_conf = {
    'examples_dirs': '../../examples',
    'gallery_dirs': 'api/gallery',
    'filename_pattern': r'/plot_',
    'download_all_examples': False,
    'within_subsection_order': 'FileNameSortKey',
    'remove_config_comments': True,
    # Lets ".. minigallery::" (used throughout history.rst) resolve
...
# Lets cross-references to numpy/matplotlib/scipy types in autodoc-rendered
# type hints (e.g. NDArray, Figure, Axes) resolve to their official docs
# instead of showing up as broken links.
intersphinx_mapping = {
...
project = 'tbkit'
copyright = '2014-2026, Charles Poli'
author = 'Charles Poli'
...
# The name of the Pygments (syntax highlighting) style to use. Left
# unset (as in physicskit's own conf.py) so pydata_sphinx_theme picks
# its own light/dark-aware style pair instead of a fixed one.
...
# The theme to use for HTML and HTML Help pages. Same theme as the
# sibling physicskit/mathematicskit/chemistrykit docs
# (pydata_sphinx_theme), but defaulting to light mode here rather than
# physicskit's dark default.
...
# of the sidebar.
html_logo = '_static/image/tbkit_logo.png'
...
latex_documents = [
    (master_doc, 'tbkit.tex', 'tbkit Documentation',
     'Charles Poli', 'manual'),
]
...
man_pages = [
    (master_doc, 'tbkit', 'tbkit Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'tbkit', 'tbkit Documentation',
     author, 'Charles Poli', 'solve Tight-Binding systems',
     'Miscellaneous'),
]
